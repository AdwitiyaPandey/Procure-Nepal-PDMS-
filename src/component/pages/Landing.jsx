            ...
            <section className='w-full'>
                <div className="landing-container flex justify-between items-center px-20 bg-blue-100">
                    ...
                    <form onSubmit={handleSearch} className="search flex gap-1">
                        <input value={query} onChange={e => setQuery(e.target.value)} className='border rounded py-1 w-140 text-black' type="text" placeholder="Enter your product name........" />
    ...
    <section className=' w-full  '>
        <div className="landing-container flex justify-between items-center px-20  bg-blue-100">
            ...
            <div className="search flex gap-1">
                ...
                <button className=' bg-green-600 p-1  text-lime-50'> Search <i className="bi bi-search"></i></button> 
            </div>
            ...
            <div className="navbar m-2">
                  ...
                  <ul className='flex gap-8  font-semibold'>
                    <li><i className="bi text-2xl font-bold  bi-box-arrow-in-right"></i> <br />
                        <a href="#">sign in</a></li>
                    <li>
                        <i className="bi text-2xl font-bold bi-tags"></i><br />
                        <a href="#">sell</a></li>
                    <li><i className="bi text-2xl  bi-archive-fill"></i><br />
                        <a href="#">categories</a></li>
                    <li>
                        <i className="bi text-2xl bi-person-raised-hand"></i>
                        <br /><a href="#">help</a></li>    
            const [query, setQuery] = useState('')
            const navigate = useNavigate()
