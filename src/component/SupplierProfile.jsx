...
function SupplierProfile({ user }) {
  // Local state for basic stats (In a real app, you'd fetch this from the backend)
    ...
    <div className="max-w-7xl mx-auto px-6 py-10 animate-fadeIn">
      ...
      <div className="bg-white border border-gray-200 rounded-3xl p-8 shadow-sm mb-8">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
          ...
          <button className="bg-teal-600 hover:bg-teal-700 text-white px-6 py-3 rounded-xl font-bold flex items-center gap-2 transition-all shadow-lg shadow-teal-100">
            <i className="bi bi-plus-circle"></i> List New Product
          </button>
        </div>
      </div>
